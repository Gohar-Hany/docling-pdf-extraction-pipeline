...
Usage:
    python Doc.py                          # Process the default PDF
    python Doc.py "path/to/document.pdf"   # Process a specific file
    python Doc.py "file1.pdf" "file2.pdf"  # Process multiple files
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "sources",
        nargs="*",
        default=[r"D:\Docling\Math_Session_1.pdf"],
